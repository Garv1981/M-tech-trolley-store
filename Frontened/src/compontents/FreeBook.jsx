    ...
    return (
        <div className="bg-gray-50 py-20 px-8">
            <div className="max-w-screen-xl mx-auto text-center">
                ...
                >
                    <FaRocket className="text-6xl mb-4 text-indigo-500 animate__animated animate__bounceIn" />
                    <h1 className="text-4xl md:text-5xl font-extrabold tracking-wider leading-tight">Explore the Latest Trolley Collections!</h1>
                    <p className="text-lg md:text-xl mt-4 opacity-80">
                        Discover a curated selection of products that bring charm, quality, and affordability at your house.
                    </p>
                </motion.div>
