    ...
    <>
      ...
      >
        <div className="max-w-screen-xl mx-auto px-6 sm:px-10 text-center">
          ...
          >
            At M-TECH, we don’t just sell trollies, we curate an experience of self-expression. Our passion is to provide trendy, premium, and comfortable trollies that makes you feel confident in any situation.
          </motion.p>
          <motion.p
          ...
          >
            What began with a single idea—to make affordable, high-quality fashion for all—has now turned into a journey of creativity and self-expression. Our mission is simple: empower people through interiors of the house that feels as good as it looks.
          </motion.p>
        </div>
      ...
      <section className="py-20 bg-white">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto mb-8">
            We’re committed to creating a premium shopping experience that is accessible to everyone. Whether it’s top-notch material, affordable pricing, or exceptional service, our values shine through in everything we do.
          </p>
        </div>
        <div className="grid md:grid-cols-3 gap-8 px-6 sm:px-10">
          ...
          >
            ...
            <p className="text-gray-600 text-sm">
              Fashion should be for everyone. We believe in making stylish, high-quality product available to all without breaking the bank.
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="text-gray-600 text-sm">
              Only the best material make it to our collections, ensuring that every piece you wear feels luxurious and lasts for years to come.
            </p>
          </motion.div>
      ...
      >
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Our mission is to empower individuals to feel beautiful and confident in choosing the interior products. By embracing diversity, sustainability, and top-tier craftsmanship, we aim to bring everyone the fashion they deserve.
          </p>
        </div>
