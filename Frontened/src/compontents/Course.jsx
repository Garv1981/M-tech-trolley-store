      ...
      <div className="bg-white text-gray-900 py-12 px-6 sm:px-8 lg:px-16">
        ...
        >
          ...
          <h1 className="text-4xl sm:text-5xl font-bold text-gray-800 mb-4">
            Find the suitable designs 
          </h1>
          <p className="text-lg sm:text-xl max-w-2xl mx-auto text-gray-600 mb-8">
            A curated selection of the latest trends. Explore fresh styles to refresh your home interior designs.
          </p>
          <motion.button
        ...
        <div className="mt-20 text-center bg-gray-50 p-12 rounded-lg shadow-lg">
          ...
          >
            Refresh Your Design Today
          </motion.h2>
          <p className="text-lg sm:text-xl text-gray-600 mb-6">
            Explore exclusive collections and find the perfect pieces for any theme.
          </p>
          <Link to="/collections">
            <motion.button
              whileHover={{ scale: 1.05 }}
        ...
        <div className="mt-16 p-12 bg-gray-50">
          ...
          <div className="flex justify-center space-x-8">
            ...
            >
              ...
              <p className="font-semibold text-gray-700">Yash Shukla</p>
            </motion.div>
            ...
            >
              ...
              <p className="font-semibold text-gray-700">Vansh Madaan</p>
            </motion.div>
          </div>
        </div>
      </div>
